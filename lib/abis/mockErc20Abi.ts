export const mockErc20Abi = [
  {
    inputs: [{ internalType: "address", name: "_helperTestnet", type: "address" }],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  { inputs: [], name: "InvalidChainId", type: "error" },
  {
    inputs: [{ internalType: "uint256", name: "supplyAfterMint", type: "uint256" }],
  ...
  {
    inputs: [{ internalType: "address", name: "_bridgeTokenSender", type: "address" }],
