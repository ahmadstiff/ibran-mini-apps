    ...
    switch (type) {
      case "supply":
        return {
          ...
          status: isConfirming ? "Supplying..." : isSuccess ? "Supplied" : "Supply Success",
        };
      case "borrow":
        return {
          ...
          status: isConfirming ? "Borrowing..." : isSuccess ? "Borrowed" : "Borrow Success",
        };
      case "withdraw":
        return {
          ...
          status: isConfirming ? "Withdrawing..." : isSuccess ? "Withdrawn" : "Withdraw Success",
        };
      default:
        return {
          ...
          status: isConfirming ? "Processing..." : isSuccess ? "Completed" : "Pending",
        };
    }
  };
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          ></div>
          <span className={`text-sm ${config.textColor} font-semibold`}>{config.status}</span>
        </div>
        {txHash && (
          <a
