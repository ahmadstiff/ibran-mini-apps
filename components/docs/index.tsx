    ...
    <div className="min-h-screen  flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-8 max-w-2xl mx-auto px-6">
        ...
        <div className="space-y-4">
          <h1
            className={`text-4xl md:text-5xl font-bold text-white transition-all duration-1000 ease-out ${
          ...
          <p
            className={`text-xl text-gray-300 transition-all duration-1000 delay-300 ease-out ${
              animationPhase >= 1 ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
            Documentation
        ...
        {/* Progress Bar */}
        <div
          className={`w-full max-w-md mx-auto transition-all duration-1000 delay-700 ease-out ${
            animationPhase >= 2 ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
          }`}
        >
          <div className="bg-gray-800/50 rounded-full h-2 overflow-hidden backdrop-blur-sm">
            <div
              className={`h-full bg-gradient-to-r from-blue-500 to-purple-600 rounded-full transition-all duration-3000 ease-out ${
