...
const TransactionTypeBreakdown: React.FC<TransactionTypeBreakdownProps> = ({ typeBreakdown }) => {
    ...
    <Card className="bg-gradient-to-br from-gray-900/80 to-gray-900/80 border border-gray-700/60 backdrop-blur-md shadow-lg">
      <CardContent className="p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-lg font-semibold text-white">Transaction Types Overview</h3>
        </div>
